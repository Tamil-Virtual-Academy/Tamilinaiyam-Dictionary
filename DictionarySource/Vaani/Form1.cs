...
using VaaniEditor;
//using System.Runtime.InteropServices;
//using System.Windows.Controls;//added presentationFramework


#region namespace for dictionary search
namespace Vaani
{
    ...
    public partial class Vaani : Form
    {
        ...
        public Vaani()
        {
            ...
            panel3.Visible = true;
             ...
             பழதரததToolStripMenuItem.Visible = false;
             அகரதToolStripMenuItem.Visible = true;
             home.Visible = false;
             this.Text = "தமிழிணைய அகராதி";
            //logo


             webBrowser1.DocumentText = "<html><body></body></html>";
            panel4.Size = new Size(this.ClientSize.Width + 1, this.ClientSize.Height); // Screen.PrimaryScreen.WorkingArea.Size;
            panel3.Size = new Size(this.ClientSize.Width + 1, this.ClientSize.Height); //Screen.PrimaryScreen.WorkingArea.Size;
            

            //richTextBox1.Size = new Size(panel4.ClientSize.Width+1,panel4.ClientSize.Height);// Screen.PrimaryScreen.WorkingArea.Size;
            //richTextBox1.Size = new Size(this.ClientSize.Width + 1, this.ClientSize.Height - 100);
            ...
            //styleSheet.cssText = @".result-panel {width:100%;padding:3px;display: block;text-decoration: none;background:#C2DEE6;border-left: 8px solid #00A3CC;-moz-border-radius: 9px 3px 9px 3px;-webkit-border-radius: 3px;-webkit-border-top-left-radius: 9px;-webkit-border-bottom-right-radius:9px;}";
            StreamReader r = new StreamReader(@"koppu\User.Txt");
            string txt = r.ReadToEnd();
            txt = txt.Replace("\r\n", "\n");//since richtextbox to textbox
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (tBox.Text.Length > 0)//action for before correction
            {
                panel.Visible = false;
                hBox.Text = null;
                string aword = tBox.Text;//All word
                ...
                for (int i = 0; i < rword.GetLength(0); i++)//multi dimension array length of first
                {
        ...
        #region to add new words below function needs to be called
        ...
        #region to add new suggestion, below function will be called
        ...
        #region when textbox content changed then below function will be called and transliteration will happen
        ...
        #region capture the user keypress and process it
        ...
        #region set default values when clear button is clicked
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(word))
            {
                ...
                while (Index <= limit)//for multiple repeats
                {
                    ...
                    Index = rBox.Text.IndexOf(word, Index);//no increment is needed since word was replaced
                }
        ...
        {//full result or suggestion is vagai
        ...
        #region validate the content in the richtextbox1 and retirn the result
        ...
        #region check if the char is tamil or any special character
        ...
        #region escape the unicode for rtf format
        ...
        #region fill search result in suggestion box
